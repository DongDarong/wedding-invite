...
<template>
  <section
    ...
    @dragstart.prevent
  >
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(158,27,50,0.24),transparent_45%),linear-gradient(140deg,#2a1d10_0%,#1b1309_56%,#3b2916_100%)]"></div>
    ...
    <div class="absolute inset-0 flex items-center justify-center px-8 mt-auto text-center">
      <div class="intro-center max-w-2xl space-y-5" :class="{ 'intro-center-lite': lite }">
        ...
        <p class="font-khmer-body text-[11px] tracking-[0.3em] text-[#9E1B32]/85 intro-fade" :class="{ 'intro-fade-lite': lite }">
...
.intro-aurora {
  background:
    radial-gradient(circle at 10% 20%, rgba(178, 34, 34, 0.18), transparent 42%),
    radial-gradient(circle at 85% 18%, rgba(158, 27, 50, 0.2), transparent 38%),
    radial-gradient(circle at 50% 110%, rgba(139, 0, 0, 0.16), transparent 45%);
  filter: blur(16px);
...
.intro-sparkles {
  background:
    radial-gradient(circle at 16% 26%, rgba(178, 34, 34, 0.56) 0 1px, transparent 2px),
    radial-gradient(circle at 78% 22%, rgba(158, 27, 50, 0.5) 0 1px, transparent 2px),
    radial-gradient(circle at 58% 66%, rgba(139, 0, 0, 0.45) 0 1px, transparent 2px),
    radial-gradient(circle at 28% 74%, rgba(178, 34, 34, 0.42) 0 1px, transparent 2px);
...
.temple-door {
  background:
    ...
    repeating-linear-gradient(
      90deg,
      rgba(178, 34, 34, 0.11) 0,
      rgba(178, 34, 34, 0.11) 2px,
      transparent 2px,
      transparent 12px
    );
...
.intro-center {
  ...
  background:
    ...
    radial-gradient(circle at 50% 0%, rgba(178, 34, 34, 0.16), transparent 56%);
  box-shadow:
    inset 0 1px 0 rgba(178, 34, 34, 0.34),
    inset 0 0 48px rgba(158, 27, 50, 0.08),
...
.intro-center-lite {
  box-shadow:
    inset 0 1px 0 rgba(178, 34, 34, 0.28),
...
.left-door {
  border-right: 1px solid rgba(178, 34, 34, 0.36);
  animation: open-left 7s cubic-bezier(0.7, 0, 0.2, 1) forwards;
}

.right-door {
  border-left: 1px solid rgba(178, 34, 34, 0.36);
...
.intro-cta {
  box-shadow: 0 8px 22px rgba(0, 0, 0, 0.34), inset 0 1px 0 rgba(178, 34, 34, 0.45);
}
...
.intro-beam {
  background: linear-gradient(
    110deg,
    transparent 32%,
    rgba(158, 27, 50, 0.2) 48%,
    rgba(178, 34, 34, 0.45) 52%,
    rgba(139, 0, 0, 0.18) 56%,
    transparent 72%
  );
